...
class Handler:
    ...
    def onSettingChanged(self, *args):
        ...
        x = Gdk.RGBA()
        iface.bg_color.get_rgba(x)
        s.bg_color = rgbaToHexString(x)
        iface.text_color.get_rgba(x)
        s.text_color = rgbaToHexString(x)
        iface.high_color.get_rgba(x)
        s.high_color = rgbaToHexString(x)
        iface.med_color.get_rgba(x)
        s.medium_color = rgbaToHexString(x)
        iface.low_color.get_rgba(x)
        s.low_color = rgbaToHexString(x)
